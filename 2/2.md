...
**RF22 - Mostrar el precio total de la venta**
...
**RF26- Muestra de todos los productos**
...
**RF27 - Búsqueda de productos por categoría**
...
**RF28 - Búsqueda de productos por nombre**
...
**RF29 - Búsqueda de productos por proveedor**
...
**RF30 - Pestaña de Mantenimiento de producto**
...
**RF31 - Cajas de texto para rellenar datos de los productos**
Se dará una caja de texto para el código, nombre, precio y cantidad de los productos.

**RF32 - Combobox para obtener datos exteriores**
...
**RF35 - Botón para eliminar producto**
